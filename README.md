...
a from-source Unix-like operating system. NORD is a minimalist system
suitable for server or embedded use or as a base for desktop systems.
It is built to start fast and run light. It uses the Linux kernel
and Linux-related packages but is more focused on Unix and POSIX.
